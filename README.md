...
<head>
    ...
    <title>DOJ Defense Attorney Interactive Guide</title>
    ...
    <!-- Visualization & Content Choices:
        ...
        - Report Info: Search & Seizure Warrant/Exceptions. Goal: Inform/Organize. Viz/Method: Hierarchical styled HTML divs with explicit connections. Interaction: None. Justification: Structurally clarifies conditions and exceptions. Method: HTML/Tailwind.
        ...
        - Report Info: Specific Legislation (Marijuana, Weapons, Speed Limits). Goal: Inform/Organize. Viz/Method: Accordion/collapsible sections for each act. Interaction: User clicks to reveal definitions, limits, enforcement. Justification: Consolidates related laws into easily browsable units. Method: HTML/JS.
    -->
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-l-4 border-yellow-500 p-3 bg-yellow-50 rounded-lg">
                            ...
                            <p class="text-sm text-gray-600 italic mt-1"><span class="font-weight: bold;">Example:</span> (Trying to admit a document without proving its authenticity or relevance first).</p>
                        </div>
                        <div class="border-l-4 border-yellow-500 p-3 bg-yellow-50 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-red-600">
                        ...
                        <ul class="list-disc list-inside text-gray-700 space-y-2 text-sm">
                            ...
                            <li><span class="font-bold">No Argumentative Questions:</span> While more forceful, questions should still not be purely argumentative.</li>
